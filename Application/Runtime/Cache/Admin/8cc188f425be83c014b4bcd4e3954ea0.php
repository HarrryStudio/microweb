    ...
    <form onsubmit="return checkInput();" action="<?php echo U();?>" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-item effect_img_div" style="width:100%;">
            ...
            <div id="into_effect_img">
                <?php if($effect_img != '' ): if(is_array($effect_img)): foreach($effect_img as $key=>$vo): ?><div theme="<?php echo ($vo["id"]); ?>" class="effect_img_div">
                            <div class="handle">
                                <?php if(empty($vo["name"])): ?><span class="effect_name" style="color: red;">效果图无效</span>
                                <?php else: ?>
                                    <span class="effect_name" style="color: green;"><?php echo ($vo["name"]); ?></span><?php endif; ?>
                                <span class="delete">删除</span>
                            </div>
                            <div class="effect_img_show">
                                <img class="old_effect_img" src="/microweb/Uploads/<?php echo ($vo["savepath"]); ?>/<?php echo ($vo["savename"]); ?>">
                            </div>
...
//        $(this).children(".handle").hide();
    ...
    $(document).on("focusout",'.effect_text',function(){
        ...
        $.post(
            '/microweb/index.php/Admin/Reception/effectName',
            {
                data:name,
                id:theme_id,
            },

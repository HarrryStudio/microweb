...
<form onsubmit="return checkInput();" action="<?php echo U();?>" method="post" class="form-horizontal" enctype="multipart/form-data">
    <div class="form-item">
        ...
        <div class="controls">
            <input type="text" class="text input-large" id="column" name="column" value="<?php echo ($list["name"]); ?>">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="text" class="text input-large" id="addr_link" name="addr_link" value="<?php echo ($list["url"]); ?>">
    ...
    <div class="form-item" style="width:100%;height:auto;">
        <div style="width:150px;height:auto;overflow:hidden;">
            <div id="into_img">
                <?php if($list["icon"] != '' ): ?><img id="old_img" src="/microweb/Uploads/<?php echo ($list["savepath"]); echo ($list["savename"]); ?>"><?php endif; ?>
            </div>

...
<body>
	<div class="side main">
		<div class="user-bar">
			<div class="head-icon" style="background-image:url(/microweb/Uploads/)"></div>
		...
		<div class="nav-bar">
			<div class="nav-item active" data-column="27">
				<a href="阿斯顿顶顶顶顶.html">
					...
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/img/2015-09-12/img/2015-09-12/)"></span>

...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/microweb/UserFiles/Public/Theme/Public/index.css">
			<link rel="stylesheet" type="text/css" id="theme-css" href="/microweb/UserFiles/Public/Theme/theme-1/theme.css">
		<script type="text/javascript" id="theme-js" src="/microweb/UserFiles/Public/Theme/theme-1/theme.js"></script>	<link rel="stylesheet" type="text/css" href="/microweb/UserFiles/Public/Controller/PicturesShow/PicPhoneShow.css">
...
<body>
	<div class="side main">
		...
		<div class="nav-bar">
			<div class="nav-item active" data-column="193">
				<a href="index.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/)"></span>
					<span class="nav-name">主页</span></a>
				</div>											<div class="nav-item" data-column="194"><a href="dfs.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/)"></span>
					<span class="nav-name">地方 </span></a>
				</div>											<div class="nav-item" data-column="195"><a href="555.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/)"></span>
					<span class="nav-name">广泛的</span></a>
				</div>											<div class="nav-item" data-column="196"><a href="66.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/)"></span>
					<span class="nav-name">55</span></a>
				</div>											<div class="nav-item" data-column="197"><a href="77.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/)"></span>
					<span class="nav-name">55</span></a>
				</div>											<div class="nav-item" data-column="198"><a href="jh.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/)"></span>
					<span class="nav-name">132</span></a>
				</div>											<div class="nav-item" data-column="199"><a href="99.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/column/2015-09-27/column/2015-09-27/)"></span>
					<span class="nav-name">57</span></a>
				</div>		</div>

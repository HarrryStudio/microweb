...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/microweb_v2/Public/Home/css/index.css" />
	<script type="text/javascript" src='/microweb_v2/Public/Static/jquery-2.0.3.min.js'></script>
	<script type="text/javascript" src="/microweb_v2/Public/Home/js/index.js"></script>
</head>

<body>
	<div id="scoller_top">
	<img id="top_img" src="/microweb_v2/Public/Home/images/back/logo.png">
		<ul>
		...
		<div id="forth_screen" class="screen">
			...
			<div id="forth_screen_info_left" class="tilt">
				<div class="forth_left_show recover">
					<img src="/microweb_v2/Public/Home/images/back/clipboard.png">
				</div>
			</div>
			<div id="forth_screen_info_right" class="tilt">
				<div class="forth_right_show recover">
					<img src="/microweb_v2/Public/Home/images/back/link.png">

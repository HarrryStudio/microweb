...
<body>
	<div class="side main">
		...
		<div class="nav-bar">
			<div class="nav-item active" data-column="183">
				<a href="index.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/column/2015-09-18/column/2015-09-18/)"></span>
					<span class="nav-name">主页</span></a>
				</div>											<div class="nav-item" data-column="184"><a href="news.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/column/2015-09-18/column/2015-09-18/)"></span>
					<span class="nav-name">新闻消息</span></a>
				</div>											<div class="nav-item" data-column="185"><a href="about.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/column/2015-09-18/column/2015-09-18/)"></span>
					<span class="nav-name">关于我们</span></a>
				</div>											<div class="nav-item" data-column="186"><a href="link.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/column/2015-09-18/column/2015-09-18/)"></span>
					<span class="nav-name">联系我们</span></a>
				</div>											<div class="nav-item" data-column="187"><a href="help.html">
					<span class='nav-icon' style="background-image:url(/microweb/Uploads/)"></span>
					<span class="nav-name">帮助中心</span></a>
				</div>		</div>

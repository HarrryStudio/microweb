$(function(){
	...
	var flag = false;
	var url = $(".production_info a").attr('url');
...
function save() {
	...
	var production_url = $("#production_url").val();
	var option ={title:title, column_id:column_id, column_url:column_url, selected:selected, production_url:production_url};
	var data = {name:"productionList", theme:theme, source:"production", option:option};
